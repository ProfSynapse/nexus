...
export type ImageModel =
  ...
  | 'gemini-3.1-flash-image'         // Google Nano Banana 2, GA id, the default (Google direct and OpenRouter)
  | 'gemini-3.1-flash-lite-image'    // Google Nano Banana 2 Lite (Google direct and OpenRouter)
