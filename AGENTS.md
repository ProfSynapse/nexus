...
- Fixed 3 stale validation probes: `gpt-5-nano` needs `max_completion_tokens`; `Codex-3-5-haiku-latest` deprecated → `Codex-haiku-4-5-20251001`
...
- Added Codex Sonnet 4.6 (`Codex-sonnet-4-6`): 200K ctx, 64K out, $3/$15/M + 1M beta variant
...
- `connector.ts` - MCP server connector for Codex Desktop
...
- Configured in Codex Desktop's `claude_desktop_config.json`
...
- Resume: `Codex --resume f2266b8f-b5ca-4b90-a87e-db0a0304ffd7`
- Team: `pact-f2266b8f`
